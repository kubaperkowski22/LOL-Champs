...
public class ChampionJsonAdapter(
  moshi: Moshi
) : JsonAdapter<Champion>() {
  ...
  public override fun toString(): String = buildString(30) {
      append("GeneratedJsonAdapter(").append("Champion").append(')') }

  public override fun fromJson(reader: JsonReader): Champion {
    var id: String? = null
  ...
  public override fun toJson(writer: JsonWriter, value_: Champion?): Unit {
    if (value_ == null) {
